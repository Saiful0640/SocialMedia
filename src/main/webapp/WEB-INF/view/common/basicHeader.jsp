    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link me-5" href="/coverpage"><img id="photoImageBheader" class="me-1" alt="image pay nai"
                ...
                <li class="nav-item dropdown" style="">
                    ...
                    <ul class="dropdown-menu" style="left: -310px;width: 350px; padding: 10px">
                        <li class=" border-bottom border-3"><a class=" me-5 " href="/coverpage"><img id="photoImagedrop" class="mx-1" alt="image pay nai"
                                                           src="/resources/file/profile.jpeg"
