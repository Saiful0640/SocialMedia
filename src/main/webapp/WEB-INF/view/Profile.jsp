...
<div class="row" style="background-color:#eeeeee">
    ...
    <div class="col-xl-2 border-bottom border-3 " >
        <a class=" me-5" href="/coverpage"><img id="photoImage" class="me-1 my-3" alt="image pay nai" src="/resources/file/profile.jpeg" style="width: 25px; height: 25px;text-decoration:none "><b><span><%out.print(session.getAttribute("name")); %></span></b></a>
       <%-- <p>${message}</p>--%>
